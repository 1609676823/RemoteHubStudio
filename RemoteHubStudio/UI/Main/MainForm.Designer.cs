...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        _resetWindowButton = new AntdUI.Button();
        ...
        _stopConnectionButton = new AntdUI.Button();
        ...
        _header.Controls.Add(_resetWindowButton);
        ...
        // _resetWindowButton
        //
        _resetWindowButton.AccessibleName = "重置窗口 / Reset window";
        _resetWindowButton.Anchor = AnchorStyles.Top | AnchorStyles.Right;
        _resetWindowButton.Ghost = true;
        _resetWindowButton.IconSvg = "ExpandOutlined";
        _resetWindowButton.Location = new Point(782, 11);
        _resetWindowButton.Name = "_resetWindowButton";
        _resetWindowButton.Radius = 8;
        _resetWindowButton.Size = new Size(128, 36);
        _resetWindowButton.TabIndex = 0;
        _resetWindowButton.Text = "重置窗口 / Reset window";
        _toolTip.SetToolTip(_resetWindowButton, "恢复默认窗口大小并居中 / Restore default window size and center");
        //
        // _settingsButton
        //
        ...
        _toolbar.Controls.Add(_stopConnectionButton);
        ...
        _stopConnectionButton.AccessibleName = "停止连接 / Stop connection";
        _stopConnectionButton.AutoSize = true;
        _stopConnectionButton.AutoSizeMode = AntdUI.TAutoSize.Width;
        _stopConnectionButton.Enabled = false;
        _stopConnectionButton.Height = 38;
        _stopConnectionButton.IconSvg = "StopOutlined";
        _stopConnectionButton.Margin = new Padding(0, 0, 8, 4);
        _stopConnectionButton.Name = "_stopConnectionButton";
        _stopConnectionButton.Radius = 8;
        _stopConnectionButton.Tag = "stop-connection";
        _stopConnectionButton.Text = "停止连接 / Stop connection";
        _stopConnectionButton.Type = AntdUI.TTypeMini.Error;
        _stopConnectionButton.Visible = false;
        _stopConnectionButton.Width = 160;
